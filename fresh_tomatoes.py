...
movie_tile_content = '''
<div class="col-md-6 col-lg-4 movie-tile text-center" title = "{movie_other_info}" data-trailer_src="{trailer_src}" data-toggle="modal" data-target="#trailer">
...
def create_movie_tiles_content(movies):
    ...
    for movie in movies:
        ...
        content += movie_tile_content.format(
            ...
            movie_other_info=movie.show_other_info()
        )
    return content

def open_movies_page(movies):
  # Create or overwrite the output file
  output_file = open('fresh_tomatoes.html', 'w', encoding='utf-8')
